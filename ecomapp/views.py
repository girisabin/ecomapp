...
class KhaltiVerifyView(View):
	def get(self, request, *args, **kwargs):
		...
		headers = {
		  "Authorization": "Key test_secret_key_7358ed99ec684728a94f4fc16c92e006"
		}
...
class CustomerLoginView(FormView):
	...
	# form_valid is a type of post method and is available in createview formview and updateview 
	def form_valid(self, form):
...
class AdminRequiredMixing(object):
	def dispatch(self, request, *args, **kwargs):
...
class AdminHomeView(AdminRequiredMixing, TemplateView):
...
class AdminOrderDetailView(AdminRequiredMixing, DetailView):
...
class AdminOrderListView(AdminRequiredMixing, ListView):
	template_name = "adminpages/adminorderlist.html"	
	queryset = Order.objects.all().order_by("-id")
	context_object_name = "allorders"	

class AdminOrderStatusChangeView(AdminRequiredMixing, View):
...
class AdminProductListView(AdminRequiredMixing, ListView):
	template_name = "adminpages/adminproductlist.html"
	queryset = Product.objects.all().order_by("-id")
	context_object_name = "allproducts"


class AdminProductCreateView(AdminRequiredMixing, CreateView):
